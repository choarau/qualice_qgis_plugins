...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="1" simplifyLocal="1" maxScale="0" minScale="1e+08" simplifyAlgorithm="0" simplifyDrawingTol="1" version="3.10.6-A Coruña" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style isExpression="0" fontLetterSpacing="0" fontSize="15" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontFamily="MS Shell Dlg 2" fontStrikeout="0" useSubstitutions="0" textColor="31,120,180,255" textOpacity="1" fontItalic="0" blendMode="0" multilineHeight="1" fieldName="Nom" fontWeight="50" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" namedStyle="Normal" fontWordSpacing="0" fontSizeUnit="Point" fontCapitals="0">
      ...
      <placement geometryGeneratorType="PointGeometry" geometryGenerator="" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" overrunDistanceUnit="MM" xOffset="-3" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" layerType="PolygonGeometry" preserveRotation="1" maxCurvedCharAngleIn="25" repeatDistance="0" rotationAngle="0" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" centroidWhole="0" offsetUnits="MM" maxCurvedCharAngleOut="-25" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" dist="0" placement="0" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" fitInPolygonOnly="0" quadOffset="4"/>
