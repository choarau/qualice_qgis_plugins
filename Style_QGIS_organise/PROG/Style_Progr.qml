...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" maxScale="0" minScale="1e+08" simplifyAlgorithm="0" simplifyDrawingTol="1" version="3.10.6-A Coruña" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{612db9d2-9c60-4b8d-b83c-c00951d1f672}">
      <rule symbol="0" key="{3ddcb6e1-405e-4b4b-b6fd-0ed3c0f7d0b9}" filter=" &quot;PROG&quot;  = 'Maintenue'"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          ...
          <prop k="outline_color" v="177,27,187,255"/>
  ...
  <aliases>
    <alias name="" index="0" field="ID_MAILLE"/>
    <alias name="" index="1" field="PROG"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" expression="" field="ID_MAILLE"/>
    <default applyOnUpdate="0" expression="" field="PROG"/>
  </defaults>
  <constraints>
    <constraint constraints="0" unique_strength="0" field="ID_MAILLE" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="PROG" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="ID_MAILLE"/>
    <constraint desc="" exp="" field="PROG"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column width="-1" type="field" name="ID_MAILLE" hidden="0"/>
      <column width="-1" type="field" name="PROG" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="ID_MAILLE" editable="1"/>
    <field name="PROG" editable="1"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="ID_MAILLE"/>
    <field labelOnTop="0" name="PROG"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>ID_MAILLE</previewExpression>
  <mapTip></mapTip>
